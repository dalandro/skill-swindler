...
A Claude Code skill that asks once at the end of multi-step sessions whether the work felt repeatable, and writes a candidate skill description to a local folder if you say yes.
